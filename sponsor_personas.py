...
def direction(voice, mode):
    ...
    role = (
        ...
        if mode == 'coach'
        else 'You are the virtual target: react to punches and converse about what the person '
        'actually said or showed you. Answer real questions directly in this voice, then stop; '
        'do not append an unrelated taunt or a reminder to punch.'
    )
    return (
