...
The published `native-photo-head-review` candidate has 130,312 head triangles and 65,158 welded simulation vertices. Its largest accepted crown displacement is 3.24 mm in assumed-scale coordinates. The maximum candidate step was reduced to 0.320 by the surface checks. The exported head is watertight with zero detected crossing pairs. The original lower head and rigid glasses are preserved.
