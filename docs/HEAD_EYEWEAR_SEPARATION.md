...
The current review is `native-photo-head-review`, rebuilt from the separated-eyewear preparation of capture `7a2bc070892642999d3357c2c5838390`: 130,312 head triangles, 65,158 welded simulation vertices, and 17 separate eyewear meshes. The crown refinement and registered front reference are described in [HEAD_CROWN_GEOMETRY.md](HEAD_CROWN_GEOMETRY.md). Detection confidence was 0.99 from the saved seven-view analysis; that score is not a calibrated probability. The eyewear stage replaced 16,916 fused triangles with 19,626 socket/temple triangles. The original frame provided 21 and 30 accepted dark-edge width samples out of 48 per rim; unsupported samples retain bounded priors. Per-frame cleanup registrations take precedence over the legacy root-level front cache.
