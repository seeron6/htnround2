...
seconds of sound from the room during the exchange: their breathing, their grunts, whoever is watching. Use what you
hear the way a fighter would. If they are gassed, you noticed.
HOW YOU TALK:
        ...
        messages.append(
            {
                'role': 'user',
                'content': (
                    'That sound is the room during the exchange: their breathing, their grunts, '
                    'whoever is watching. Nobody is asking you anything. '
                    if heard
                    else ''
                )
                + (
...
class Handler(BaseHTTPRequestHandler):
    ...
    def express(self, cfg, data, started, turn_span=None):
        ...
        try:
            request = omni_senses.expression_request(
    ...
    def coach(self, data):
        ...
        try:
            ...
            with (
                ...
                mood = None
                if mode == 'face' and data.get('expressions', True):
