...
def repair_scanned_eyewear(
    ...
    out = trimesh.Trimesh(
        ...
        visual=trimesh.visual.TextureVisuals(
            ...
            material=trimesh.visual.material.PBRMaterial(
                # The captured albedo carries baked lighting, but a fully
                # matte response hides the crown strands in turned views.
                # Keep the photo color and give the head a restrained skin/hair
                # highlight; independent eyewear materials remain untouched.
                baseColorTexture=newimage, roughnessFactor=0.72
            ),
        ),
        process=False,
    )
    ...
    audit = {
        ...
        'lensOpacity': 0.17 + spec.get('lensTint', 0) * 0.03,
